...
##调试更改文件.
path = r"C:\Users\yongjiangao\TEST_EVR\QA_EVR.xlsx"
...
for row in range(EvaData.shape[0]):
    ...
    newPath="C:\\Users\\yongjiangao\\TEST_EVR\\替换结果\\"+str(EvaData['Model description'][row])+" "+str(EvaData['Flow2'][row])+" EVR.xlsx"
    ...
    xlSheet= xlBook.Worksheets('sheet1')
    xlSheet.Cells(7,2).Value="Application Name:  "+str(EvaData['Model description'][row])+" Program"
    ...
    xlSheet.Cells(20,4).Value=EvaData['Checksum_Data'][row]
